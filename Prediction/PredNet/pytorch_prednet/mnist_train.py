...
#val_file = os.path.join(DATA_DIR, 'test_image.hkl')
#val_sources = os.path.join(DATA_DIR, 'test_label.hkl')
...
for epoch in range(num_epochs):
    ...
    for i, inputs in enumerate(train_loader):
        ...
        optimizer.step()
        if i%10 == 0:
            print('Epoch: {}/{}, step: {}/{}, errors: {}'.format(epoch, num_epochs, i, len(kitti_train)//batch_size, errors.data))

torch.save(model.state_dict(), '../output/training_mnist.pt')
