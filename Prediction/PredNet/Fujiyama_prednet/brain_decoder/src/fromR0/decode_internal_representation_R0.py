"""For decoding predictive images from estimated internal representations."""
#
# Usage:
#   python decode_internal_representation_R0.py \
#   --sequences <path to sequence list file> \
#   --gpu <GPU ID> \
#   --initmodel <absolute path to your best model> \
#   --internal_repesentation_path <absolute path to predicted internal representation> \
...
import net_decode_internal_representation_R0

parser = argparse.ArgumentParser(description='PredNet')
# TODO: Specify the default value as an example.
...
# Create Model
prednet = net_decode_internal_representation_R0.PredNet(
