...
#
# Usage:
#   python decode_internal_representation_R2.py \
...
import net_decode_internal_representation_R2
...
# Create Model
prednet = net_decode_internal_representation_R2.PredNet(
    args.size[0], args.size[1], args.channels, args_internal_representation_path)
