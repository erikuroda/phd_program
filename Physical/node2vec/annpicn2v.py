...
# ファイル一覧
files = glob.glob("/Storage/kuroda/M2/CLEVRER/executor/data/annotation_train/annotation_00000-01000/annotation_000*.json")
ann_list = sorted(files)
print('im_list ok::::::::::')

# 物体検知後の画像読み込み
im_files = glob.glob("/Storage/kuroda/M2/CLEVRER/executor/data/after_kenchi_00999/sim_000*/output_*.png")
...
for ann in ann_list:
    ann_f = my_removeprefix(ann, '/Storage/kuroda/M2/CLEVRER/executor/data/annotation_train/annotation_00000-01000/annotation_')
...
for key, p in pos_dict.items():
    ...
    model = word2vec(walks, size=3072, min_count=0, window=7, workers=4)
    # walks: 対象
    # size: 中間層の数（分散表現の次元）
    # window: 周辺単語の数
...
print('concate_start!!!:::')
print('3D+sokudo:::')
con = np.concatenate((v_array, v_ar), axis = 1)
print('saving_start:::')
np.save('/Storage/kuroda/M2/CLEVRER/executor/data/clv_3dpos_v_999_211129', con)
print('ok!!!!')

print('3D+sokudo+img:::')
con = np.concatenate((v_array, img_array, v_ar), axis = 1)
print('saving_start:::')
np.save('/Storage/kuroda/M2/CLEVRER/executor/data/clv_3dpos_v_img_999_211129', con)
print('ok!!!!')

print('3D+sokudo+kasokudo:::')
con = np.concatenate((v_array, v_ar, angv_ar), axis = 1)
print('saving_start:::')
np.save('/Storage/kuroda/M2/CLEVRER/executor/data/clv_3dpos_v_angv_999_211129', con)
print('ok!!!!')

print('3D+sokudo+kasokudo+img:::')
con = np.concatenate((v_array, img_array, v_ar, angv_ar), axis = 1)
print('saving_start:::')
np.save('/Storage/kuroda/M2/CLEVRER/executor/data/clv_3dpos_v_angv_img_999_211129', con)
print('ok!!!!')

print('3D+sokudo+kasokudo+move_rec:::')
con = np.concatenate((v_array, v_ar, angv_ar, s_all), axis = 1)
print('saving_start:::')
np.save('/Storage/kuroda/M2/CLEVRER/executor/data/clv_3dpos_v_angv_move_999_211129', con)
print('ok!!!!')

print('3D+sokudo+kasokudo+move_rec+img:::')
con = np.concatenate((v_array, img_array, v_ar, angv_ar, s_all), axis = 1)
print('saving_start:::')
np.save('/Storage/kuroda/M2/CLEVRER/executor/data/clv_3dpos_v_angv_move_img_999_211129', con)
print('ok!!!!')

print('3D+move_rec:::')
con = np.concatenate((v_array, s_all), axis = 1)
print('saving_start:::')
np.save('/Storage/kuroda/M2/CLEVRER/executor/data/clv_3dpos_move_999_211129', con)
print('ok!!!!')

print('3D+move_rec+img:::')
con = np.concatenate((v_array, img_array, s_all), axis = 1)
print('saving_start:::')
np.save('/Storage/kuroda/M2/CLEVRER/executor/data/clv_3dpos_move_img_999_211129', con)
print('ok!!!!')
