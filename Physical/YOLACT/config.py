...
my_custom_dataset = dataset_base.copy({
    ...
    'has_gt': True,
    'class_names': ('cube_gray', 'cube_red', 'cube_blue', 'cube_green', 'cube_brown', 'cube_cyan',
                    'cube_purple', 'cube_yellow', 'sphere_gray', 'sphere_red', 'sphere_blue',
                    'sphere_green', 'sphere_brown', 'sphere_cyan', 'sphere_purple', 'sphere_yellow',
                    'cylinder_gray', 'cylinder_red', 'cylinder_blue', 'cylinder_green', 'cylinder_brown',
                    'cylinder_cyan', 'cylinder_purple', 'cylinder_yellow'
                    ),
    'label_map': {'class_id_1': 1, 'class_id_2': 2, ...}
})
