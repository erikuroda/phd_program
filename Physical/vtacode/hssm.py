...
class HierarchicalStateSpaceModel(nn.Module):
    ...
    # set prior boundary prob 前の境界の確率
...
class EnvModel(nn.Module):
    ...
    def forward(self, obs_data_list, seq_size, init_size, obs_std=1.0):
        ...
        torch.save(boundary_data_list, '/Storage/kuroda/M2/CLEVRER/executor/data/result211003/graph_only_boundry_211004.pt')
