...
def parse_args():
    ...
    # model size
    parser.add_argument('--state-size', type=int, default=8)#8
    parser.add_argument('--belief-size', type=int, default=128) #128
    parser.add_argument('--num-layers', type=int, default=3) #3
    ...
    parser.add_argument('--savefile', type=str, default='sam')

    # data path
    parser.add_argument('--datapath', type=str, default='dim_210930.npy')
    parser.add_argument('--num_usedata', type=int, default=1000) #train+test
...
def main():
    ...
    # load dataset
    train_loader, test_loader = full_dataloader(seq_size, init_size, args.batch_size, args.datapath, args.num_usedata)
        ...
        for train_obs_list in train_loader:
            ...
            if b_idx % 100 == 0:
                ...
                with torch.no_grad():
                    ...
                    # flag保存
                    np.save('/Storage/kuroda/M2/VTA/log/{}'.format(args.savefile), results)
